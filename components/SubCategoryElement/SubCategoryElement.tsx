...
type PropsSubCategoryElement = { 
  ...
  export default function CategorySubElement({onAddToCart,nameSubCategory}:PropsSubCategoryElement){
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(`http://localhost:9196/api/product/products/by-subcategory/${nameSubCategory}`);
